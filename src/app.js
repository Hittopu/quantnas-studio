...
const staticTranslations = {
  ...
  "查看工作流": "View Workflow",
  "从任务需求到 Hugging Face 拉取清单": "From task brief to HF manifest",
  "页面先收集任务、模型池、量化方法和资源约束；后端可以接入真实 NAS 服务，返回组合配置、线性层来源和复现实验参数。": "Submit the task, model pool, quantizers, and constraints. We return the per-linear composition and evaluation metadata.",
  "任务画像": "Task Profile",
  ...
  "交付可复现配置": "Deliver the config",
  "通过邮件返回逐层 source JSON、模型拉取清单与实验元数据。": "Receive the source JSON, model manifest, and experiment metadata by email.",
  "可复现结果": "Reproducible result",
  "逐线性层来源清单": "Per-linear source manifest",
  "候选配置经过目标任务与 PPL 正式复测后，以 JSON 附件交付。": "The candidate is formally validated on the target task and PPL, then delivered as a JSON attachment.",
  "平均 bit": "Average bit",
  "正式复测": "Formal validation",
  ...
  "覆盖主流开源大模型家族": "Open-source model families",
  "当前层仓库覆盖 Qwen 与 Llama 系列，并以统一 source manifest 管理不同方法和 bit 宽度。": "Qwen and Llama sources share one manifest across quantizers and bit widths.",
  "基座模型": "Base models",
  "量化器": "Quantizers",
  "线性层选择": "Linear choices",
  "4 个模型": "4 models",
  "5 个模型": "5 models",
